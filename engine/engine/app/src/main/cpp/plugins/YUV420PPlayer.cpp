...
bool YUV420PPlayer::setup(int vidW, int vidH, int winW, int winH) {
    ...
    if(y_pixels || u_pixels || v_pixels) {
        LOGI("Already setup the YUV420PPlayer.\n");
        return false;
    }
...
bool YUV420PPlayer::setupShader() {
...
bool YUV420PPlayer::setupTextures() {
...
void YUV420PPlayer::draw(int x, int y, int w, int h) {
...
void YUV420PPlayer::setYPixels(uint8_t* pixels, int stride) {
    assert(textures_created == true);
...
void YUV420PPlayer::setUPixels(uint8_t* pixels, int stride) {
    assert(textures_created == true);
...
void YUV420PPlayer::setVPixels(uint8_t* pixels, int stride) {
    assert(textures_created == true);
