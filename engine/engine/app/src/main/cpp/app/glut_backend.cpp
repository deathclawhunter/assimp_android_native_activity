...
static void MouseCB(int Button, int State, int x, int y) {
    ...
    OGLDEV_KEY_STATE OgldevKeyState = (State == GLUT_DOWN) ? OGLDEV_KEY_STATE_PRESS
...
bool GLUTBackendCreateWindow(unsigned int Width, unsigned int Height, bool isFullScreen,
                             const char *pTitle) {
    if (isFullScreen) {
